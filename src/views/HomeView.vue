<template>
  <div>
    ...
    <!-- https://medium.com/@ldanadrian/vue-3-websockets-how-to-build-a-realtime-chat-application-in-15-minutes-3b6a8ae5c08b -->
     <!-- https://github.com/ldanadrian/sockets-bay-vuejs-chat -->
...
export default {
  name: 'HomeView',
   ...
   data(){
    return {
      sockets_bay_api_key: "demo", //here you must insert your api key from Sockets Bay
   ...
   methods:{
    ...
    //  var sockets_bay_url = `wss://socketsbay.com/wss/v2/100/${this.sockets_bay_api_key}/`;
     ...
     //MY CODE AS I DONT HAVE API FROM SOCKETSBAY
     this.websocket      = new WebSocket('https://echo.websocket.org/.ws');
      //
